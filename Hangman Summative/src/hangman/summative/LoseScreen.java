...
public class LoseScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnMainScreen.setText("Return to Main Screen");
    ...
    //when return to main screen is clicked, this screen closes and the start screen opens
    private void btnMainScreenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMainScreenActionPerformed
        
        HangmanSummative startPage = new HangmanSummative();
        startPage.setVisible(true);//start page appears
        this.dispose();//disposes this screen
